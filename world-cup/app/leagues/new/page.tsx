...
async function createLeagueAction(formData: FormData) {
  ...
  const season = String(formData.get("season") ?? "2026").trim();
  ...
  if (teamError) {
    redirect(`/leagues/new?error=${encodeURIComponent(teamError.message)}`);
  }
          ...
          <CardContent>
            <form action={createLeagueAction} className="space-y-4">
              <div className="space-y-1">
                ...
                <Input id="name" name="name" required placeholder="Office World Cup 2026" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="season">Season</Label>
                <Input id="season" name="season" defaultValue="2026" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="team_name">Your team name</Label>
                <Input id="team_name" name="team_name" required placeholder="The Group of Death" />
              </div>
              <div className="space-y-1">
                ...
                <Select id="draft_type" name="draft_type" defaultValue="manual">
                  ...
                  <option value="auto">Auto (best available by FIFA rank)</option>
                </Select>
              </div>
              {error && (
