      ...
      cookies: {
        ...
        setAll(cookiesToSet: CookieToSet[]) {
          try {
            ...
            // `set` outside a Server Action / Route Handler throws; safe to
            // ignore in Server Components where middleware already refreshed.
          }
        },
      },
    },
 ...
 * ONLY use in trusted server code (cron routes, commissioner actions,
 * draft execution) — never expose it to the client.
 */
